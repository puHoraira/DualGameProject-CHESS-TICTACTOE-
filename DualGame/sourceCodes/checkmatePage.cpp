...
// #include "chess.h"
int WINDOW_WIDTH5 = 400;
int WINDOW_HEIGHT5 = 120;
...
void start5(SDL_Renderer *xrenderer)
{
    ...
    TTF_Font *monaco = TTF_OpenFont(new_font2, 24);
    if (monaco == NULL)
    {
...
void initSDLs5()
{
    ...
    xwindow5 = SDL_CreateWindow("Game Over", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 400, 120, SDL_WINDOW_SHOWN);
